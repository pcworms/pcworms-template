...
class Free_Template{
	...
	public function enqueue_all(){
		...
		wp_enqueue_script("jquery","https://cdn.jsdelivr.net/npm/jquery@3.3.1/dist/jquery.min.js",array(),"3.3.1","all");
		...
		wp_enqueue_script("font-awesome","https://kit.fontawesome.com/5aa53ba1ac.js",array(),"custom","all");
		...
		//long-press-event
		wp_register_script('long-press-event',get_stylesheet_directory_uri() . '/assets/long-press-event/long-press-event.min.js', array(), "2.4.6", false);
		wp_enqueue_script('long-press-event');
