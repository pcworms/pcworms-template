 ...
 * Cloned from Wordpress and using custom content generator
 */
...
>
	...
	<entry>
		...
		<?php if ( ! get_option( 'rss_use_excerpt' ) ) : ?>
			<content type="<?php html_type_rss(); ?>" xml:base="<?php the_permalink_rss(); ?>"><![CDATA[<?php echo custom_get_the_content_feed( 'atom' ); ?>]]></content>
		<?php endif; ?>
