<footer class="entry-footer">
	...
	if ( $tags_list && !is_archive() && !is_front_page() ) { ?>
		<div class="tags-links">
			<span class="fa fa-tags fa-lg" title="<?php esc_attr_e('Tags', 'pcworms'); ?>" data-toggle="tooltip" data-placement="bottom"></span>&nbsp;
	...
	if ( is_single() or is_archive() ) {
		...
		if ( $categories_list  ) { ?>
			<div class="footer-item cat-links">
				<i class="fa fa-list-ul fa-lg" title="<?php esc_attr_e('Categories', 'pcworms'); ?>" data-toggle="tooltip" data-placement="bottom" aria-hidden="true"></i>
	...
	if (is_front_page() and comments_open(get_the_ID()))
		printf('<a href="%s" class="comment-btn"><i class="fa fa-comments fa-lg"></i> %s</a>',get_comments_link(),esc_html__('Write Comment', 'pcworms'));
